...
Console.print_info("Scrapping Proxies\n")
...
def http_worker():
  try:
    time.sleep(0.2)
    Console.print_info("Scrapping HTTP(s) Proxies")
    ...
    Console.print_info("Scrapped HTTP(s) Proxies")

    Console.print_info("Writing HTTP(s) Proxies")
    ...
    Console.print_info("Wrote HTTP(s) Proxies!\n")
  except Exception as e:
    Console.print_info(f"Failed To Scrap HTTP(s) Proxies: {e}\n")
    exit()

Console.print_debug("Creating HTTP(s) Worker")
th = threading.Thread(target=http_worker)
Console.print_debug("HTTP(s) Worker Created")
Console.print_debug("Starting HTTP(s) Worker")
th.start()
Console.print_debug("HTTP(s) Worker Started\n")

def socks4_worker():
  try:
    time.sleep(0.4)
    Console.print_info("Scrapping SOCKS4 Proxies")
    ...
    Console.print_info("Scrapped SOCKS4 Proxies")

    Console.print_info("Writing SOCKS4 Proxies")
    ...
    Console.print_info("Wrote SOCKS4 Proxies!\n")
  except Exception as e:
    Console.print_info(f"Failed To Scrap SOCKS4 Proxies: {e}\n")
    exit()

Console.print_debug("Creating SOCKS4 Worker")
ts4 = threading.Thread(target=socks4_worker)
Console.print_debug("SOCKS4 Worker Created")
Console.print_debug("Starting SOCKS4 Worker")
ts4.start()
Console.print_debug("SOCKS4 Worker Started\n")

def socks5_worker():
  try:
    time.sleep(0.6)
    Console.print_info("Scrapping SOCKS5 Proxies")
    ...
    Console.print_info("Scrapped SOCKS5 Proxies")

    Console.print_info("Writing SOCKS5 Proxies")
    ...
    Console.print_info("Wrote SOCKS5 Proxies!\n")
  except Exception as e:
    Console.print_info(f"Failed To Scrap SOCKS5 Proxies: {e}\n")
    exit()

Console.print_debug("Creating SOCKS5 Worker")
ts5 = threading.Thread(target=socks5_worker)
Console.print_debug("SOCKS5 Worker Created")
Console.print_debug("Starting SOCKS5 Worker")
ts5.start()
Console.print_debug("SOCKS5 Worker Started\n")

th.join()
Console.print_debug("HTTP(s) Worker Joined")
ts4.join()
Console.print_debug("SOCKS4 Worker Joined")
ts5.join()
Console.print_debug("SOCKS5 Worker Joined\n")

Console.print_info("Removing Duplicates\n")

Console.print_debug("Creating HTTP(s) Duplicates Thread")
tdh = threading.Thread(target=http_remove_duplicates)
Console.print_debug("HTTP(s) Duplicates Thread Created")
Console.print_debug("Starting HTTP(s) Duplicates Thread")
tdh.start()
Console.print_debug("HTTP(s) Duplicates Thread Started\n")

Console.print_debug("Creating SOCKS4 Duplicates Thread")
tds4 = threading.Thread(target=socks4_remove_duplicates)
Console.print_debug("SOCKS4 Duplicates Thread Created")
Console.print_debug("Starting SOCKS4 Duplicates Thread")
tds4.start()
Console.print_debug("SOCKS4 Duplicates Thread Started\n")

Console.print_debug("Creating SOCKS5 Duplicates Thread")
tds5 = threading.Thread(target=socks5_remove_duplicates)
Console.print_debug("SOCKS5 Duplicates Thread Created")
Console.print_debug("Starting SOCKS5 Duplicates Thread")
tds5.start()
Console.print_debug("SOCKS5 Duplicates Thread Started\n")

tdh.join()
Console.print_debug("HTTP(s) Duplicates Worker Joined")
tds4.join()
Console.print_debug("SOCKS4 Duplicates Worker Joined")
tds5.join()
Console.print_debug("SOCKS5 Duplicates Worker Joined\n")

# Console.print_info("Checking Proxies\n")

# def check_proxy(file, file2):
#   checker = ProxyChecker()
#   checker.checkList(file, file2)

# Console.print_debug("Creating HTTP(s) Checker Thread")
# tch = threading.Thread(target=check_proxy, args=("./proxy/http-removed.txt", "./proxy/http-checked", ))
# Console.print_debug("HTTP(s) Checker Thread Created")
# Console.print_debug("Starting HTTP(s) Checker Thread")
# tch.start()
# Console.print_debug("HTTP(s) Checker Thread Started\n")

# Console.print_debug("Creating SOCKS4 Checker Thread")
# tcs4 = threading.Thread(target=check_proxy, args=("./proxy/socks4-removed.txt", "./proxy/socks4-checked", ))
# Console.print_debug("SOCKS4 Checker Thread Created")
# Console.print_debug("Starting SOCKS4 Checker Thread")
# tcs4.start()
# Console.print_debug("SOCKS4 Checker Thread Started\n")

# Console.print_debug("Creating SOCKS5 Checker Thread")
# tcs5 = threading.Thread(target=check_proxy, args=("./proxy/socks5-removed.txt", "./proxy/socks5-checked", ))
# Console.print_debug("SOCKS5 Checker Thread Created")
# Console.print_debug("Starting SOCKS5 Checker Thread")
# tcs5.start()
# Console.print_debug("SOCKS5 Checker Thread Started\n")

# tch.join()
# Console.print_debug("HTTP(s) Checker Worker Joined")
# tcs4.join()
# Console.print_debug("SOCKS4 Checker Worker Joined")
# tcs5.join()
# Console.print_debug("SOCKS5 Checker Worker Joined\n")
